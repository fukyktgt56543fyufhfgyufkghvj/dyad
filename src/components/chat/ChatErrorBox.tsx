...
export function ChatErrorBox({
  ...
  if (error.includes("LiteLLM Virtual Key expected")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          Looks like you don't have a valid ALL AI Pro key.{" "}
          <ExternalLink href="https://dyad.sh/pro">
            Upgrade to ALL AI Pro
          </ExternalLink>{" "}
          today.
  ...
  if (isDyadProEnabled && error.includes("ExceededBudget:")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          You have used all of your ALL AI credits this month.{" "}
          <ExternalLink href="https://academy.dyad.sh/subscription">
            Upgrade to ALL AI Max
          </ExternalLink>{" "}
